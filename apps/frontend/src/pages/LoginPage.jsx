      ...
      <div className="w-full lg:w-[40%] bg-white flex flex-col justify-center px-8 sm:px-16 py-12">
        <div className="w-full max-w-sm mx-auto lg:mx-0">
          ...
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <div>
              <p className="font-['Plus_Jakarta_Sans'] text-base font-bold text-[#1D2433] leading-tight">
                Planify
              </p>
              <p className="text-[11px] text-[#64748B] leading-tight">
                Gestor de Actividades Escolares para Equipos
              </p>
            </div>
          </div>
          ...
          <p className="text-[#64748B] text-sm mb-7">
            Inicia sesión en el espacio de trabajo de tu equipo
          </p>

          <LoginForm />

          <p className="text-[11px] text-[#A0AEC0] text-center mt-5">
            Demo: lucia.ramirez@colegio.edu / planify2026
          </p>

          <p className="text-sm text-[#64748B] text-center mt-4">
            ¿No tienes una cuenta?{' '}
            <a href="/register" className="text-[#4F46E5] font-semibold hover:text-[#4338CA]">
              Regístrate aquí
            </a>
          </p>
        </div>
...
<div className="absolute top-1/2 right-8 w-4 h-4 bg-white/25 rounded-full" />
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12">
          {/* Card flotante — vidrio esmerilado (semi-transparente) */}
          <div className="w-full max-w-md bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl shadow-2xl shadow-black/20 p-5 mb-10">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="font-['Plus_Jakarta_Sans'] font-bold text-white text-[13px]">
          ...
          <p className="text-indigo-100 text-center max-w-md mb-10 text-sm">
            Planify ayuda a los equipos escolares a mantenerse alineados en cada actividad, desde
            la planificación hasta la entrega.
          </p>
  ...
  return (
    <div>
      <div className="flex justify-between text-[11px] text-white/80 mb-1">
        <span>{label}</span>
        <span className="font-['Inter'] font-semibold text-white" style={{ fontVariantNumeric: 'tabular-nums' }}>
          {percent}%
        </span>
      </div>
